...
# Create project file
{
  ...
  echo "        DYLIB_COMPATIBILITY_VERSION = 1;"
  echo "        DYLIB_CURRENT_VERSION = 1;"
  echo "        DYLIB_INSTALL_NAME_BASE = \"@rpath\";"
  echo "        LIBRARY_STYLE = STATIC;"
  echo "      };"
  echo "      name = Release;"
  echo "    };"
  echo "    4D7A7B8D0ABF745500C91562 /* Release */ = {"
  echo "      isa = XCBuildConfiguration;"
  echo "      buildSettings = {"
  echo "        PRODUCT_NAME = lua;"
  echo "        EXECUTABLE_PREFIX = lib;"
  ...
  echo "      buildConfigurations = (4D7A7B8D0ABF745500C91562 /* Release */);"
