...
# Create project file
{
  ...
  echo "        CONFIGURATION_TEMP_DIR = \"\$(PROJECT_TEMP_DIR)/\$(CONFIGURATION)\$(EFFECTIVE_PLATFORM_NAME)\";"
  echo "        CONFIGURATION_BUILD_DIR = \"\$(BUILD_DIR)/\$(CONFIGURATION)\$(EFFECTIVE_PLATFORM_NAME)\";"
  echo "        TARGET_BUILD_DIR = \"\$(BUILD_DIR)/\$(CONFIGURATION)\$(EFFECTIVE_PLATFORM_NAME)\";"
  echo "        BUILT_PRODUCTS_DIR = \"\$(BUILD_DIR)/\$(CONFIGURATION)\$(EFFECTIVE_PLATFORM_NAME)\";"
  echo "        SYMROOT = build;"
  echo "        OBJROOT = build;"
  echo "        INSTALL_PATH = /usr/local/lib;"
  echo "        PUBLIC_HEADERS_FOLDER_PATH = /usr/local/include;"
  echo "        DSTROOT = \$(BUILD_DIR);"
