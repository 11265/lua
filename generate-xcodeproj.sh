...
/* Begin XCBuildConfiguration section */
		4D7A7B8C0ABF745500C91562 /* Release */ = {
			...
			buildSettings = {
				...
				TARGET_BUILD_DIR = "$(BUILD_DIR)/$(CONFIGURATION)$(EFFECTIVE_PLATFORM_NAME)";
				...
				PUBLIC_HEADERS_FOLDER_PATH = "$(BUILD_DIR)/$(CONFIGURATION)$(EFFECTIVE_PLATFORM_NAME)/include";
				DSTROOT = "$(BUILD_DIR)";
			};
			name = Release;
		};
