...
/* Begin XCBuildConfiguration section */
		4D7A7B8C0ABF745500C91562 /* Release */ = {
			...
			buildSettings = {
				...
				TARGET_BUILD_DIR = "$(SRCROOT)/$(CONFIGURATION)$(EFFECTIVE_PLATFORM_NAME)";
				BUILT_PRODUCTS_DIR = "$(SRCROOT)/$(CONFIGURATION)$(EFFECTIVE_PLATFORM_NAME)";
				CONFIGURATION_TEMP_DIR = "$(SRCROOT)/$(CONFIGURATION)$(EFFECTIVE_PLATFORM_NAME)";
				SYMROOT = "$(SRCROOT)";
				OBJROOT = "$(SRCROOT)";
				BUILD_DIR = "$(SRCROOT)";
				INSTALL_PATH = "";
